	...
	<div class="top">
		...
		<div id="b">
			 	<c:forEach var="i" items="${p}">
					<div>			
						<a href="showAllProduct.do" name="showAllProduct.do?type=b"><img src="image/玫瑰/${i.picture.piname }" style="height: 200px; width: 200px;"></a><br><br> 
                       <a href="showAllProduct.do" name="showAllProduct.do?type=b">${i.pname}</a><br><br>
						<c:choose>
